...
public class TheWordList {

    public static ArrayList<String> easyMode = new ArrayList<String>(
            Arrays.asList("Life" , "Love" , "Wolf" , "Fish" , "Five" , "Star" ,
                    "He" , "Me" , "In" , "And" , "Any" , "Bag" , "Boy" , "Cow",
                    "Cop") );
